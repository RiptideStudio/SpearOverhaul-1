...
public class ThrownSpear : ModProjectile
{
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        target.AddBuff(base.Mod.Find<ModBuff>("BloodDebuff").Type, 240);
        if (TextureAssets.Projectile[base.Projectile.type].Value == TextureAssets.Item[base.Mod.Find<ModItem>("FrozenSpear").Type].Value && Main.rand.Next(0, 3) == 1)
        {
            target.AddBuff(44, 120);
        }
        if (TextureAssets.Projectile[base.Projectile.type].Value == TextureAssets.Item[base.Mod.Find<ModItem>("MoltenJabber").Type].Value && Main.rand.Next(0, 3) == 1)
        {
            target.AddBuff(24, 120);
        }
        if (TextureAssets.Projectile[base.Projectile.type].Value == TextureAssets.Item[base.Mod.Find<ModItem>("BramblePartisan").Type].Value && Main.rand.Next(0, 3) == 1)
        {
    ...
    public override void AI()
    {
        ...
        if (TextureAssets.Projectile[base.Projectile.type].Value == TextureAssets.Item[base.Mod.Find<ModItem>("FrozenSpear").Type].Value)
        {
        ...
        if (TextureAssets.Projectile[base.Projectile.type].Value == TextureAssets.Item[base.Mod.Find<ModItem>("MoltenJabber").Type].Value)
        {
        ...
        if (TextureAssets.Projectile[base.Projectile.type].Value == TextureAssets.Item[base.Mod.Find<ModItem>("MarbleSpear").Type].Value)
        {
