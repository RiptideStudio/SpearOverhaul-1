...
public class MarbleSpearSpear : SpearBase
{
    ...
    public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
    {
        ...
        Projectile.NewProjectile(target.GetSource_Death(), target.Center.X, target.Center.Y - 16f, 0f, 0f, base.Mod.Find<ModProjectile>("MarbleRay").Type, 0, Projectile.knockBack, player.whoAmI);
        Projectile.NewProjectile(target.GetSource_Death(), target.Center.X, target.Center.Y, base.Projectile.velocity.X, base.Projectile.velocity.Y, base.Mod.Find<ModProjectile>("Explosion").Type, Projectile.damage, Projectile.knockBack, player.whoAmI);
        base.Projectile.hostile = false;
...
//        GlobalProj.SpearHoming(Projectile, 6f);
