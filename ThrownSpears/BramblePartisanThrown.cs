...
public class BramblePartisanThrown : ModProjectile
{
	private int time;
	...
	{
		// base.DisplayName.SetDefault("Jungle Spear");
	}
	...
	public override void AI()
	{
		if (Main.rand.Next(0, 2) == 1)
		{
			Dust dust = Dust.NewDustDirect(base.Projectile.position - new Vector2(base.Projectile.velocity.X * 2f, base.Projectile.velocity.Y * 2f), base.Projectile.height, base.Projectile.width, 46, base.Projectile.velocity.X * 0.2f, base.Projectile.velocity.Y * 0.2f, 50, default(Color), 1.2f);
			dust.velocity = base.Projectile.velocity / 3f;
			dust.noGravity = true;
		}
		_ = Main.player[Main.myPlayer];
