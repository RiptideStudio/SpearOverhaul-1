...
public class CrystalSpearThrown : ModProjectile
{
    private int time;
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        if (!this.hit)
        {
            ...
            int proj = Projectile.NewProjectile(base.Projectile.GetSource_Death(), base.Projectile.Center, base.Projectile.velocity, 522, base.Projectile.damage / 2, base.Projectile.knockBack, Main.LocalPlayer.whoAmI);
    ...
    public override void AI()
    {
        ...
        {
            Dust dust = Dust.NewDustDirect(base.Projectile.position, base.Projectile.height, base.Projectile.width, 173, base.Projectile.velocity.X * 0.2f, base.Projectile.velocity.Y * 0.2f, 0, default(Color), 1.2f);
