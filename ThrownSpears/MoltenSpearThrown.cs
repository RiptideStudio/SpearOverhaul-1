...
public class MoltenSpearThrown : ModProjectile
{
	private int time;
	...
	public override void AI()
	{
		...
		{
			Dust dust = Dust.NewDustDirect(base.Projectile.position - new Vector2(base.Projectile.velocity.X * 2f, base.Projectile.velocity.Y * 2f), base.Projectile.height, base.Projectile.width, 6, base.Projectile.velocity.X * 0.2f, base.Projectile.velocity.Y * 0.2f, 0, default(Color), 1.2f);
